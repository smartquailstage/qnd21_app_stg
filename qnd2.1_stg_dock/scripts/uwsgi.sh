...
python manage.py collectstatic --settings=qnd21_app_stg.settings.stage --noinput 
...
uwsgi --socket :9000 --workers 9 --master --enable-threads --module qnd21_app_stg.wsgi  --ini uwsgi_stage.ini
